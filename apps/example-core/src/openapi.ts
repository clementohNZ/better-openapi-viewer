...
export const document: OpenAPIObject = {
  ...
  info: {
    title: 'Bookstore API',
    description: 'Tiny inline OpenAPI document used to demo the core primitives.',
    version: '1.0.0',
  },
  servers: [{ url: 'https://api.bookstore.example.com', description: 'Production' }],
  tags: [
    { name: 'books', description: 'Browse and manage the catalog' },
    { name: 'orders', description: 'Place and inspect orders' },
  ],
  components: {
    securitySchemes: {
